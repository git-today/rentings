...
public class Testfile {
    ...
    // 此处填写的存储桶名称
    private static final String bucketName = "renting-1303033920";
    // secretId
    private static final String secretId = "AKIDHPebGfAiLgrDFAfDSTFn58yWppYzeFqE";
    // secretKey
    private static final String secretKey = "IJSQM2RddMnvnOn9l7B6k5A5kUzCF2Ze";
    ...
    public static String uploadfile(File localFile) throws CosClientException, CosServiceException {
        ...
        try {
            ...
            // 指定要上传到 COS 上的路径
            fileName = "photo/"+random.nextInt(10000) + System.currentTimeMillis() + substring;
