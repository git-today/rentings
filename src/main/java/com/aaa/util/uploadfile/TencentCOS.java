package com.aaa.util.uploadfile;
...
public class TencentCOS {
	...
	// 此处填写的存储桶名称
	private static final String bucketName = "rentins-1302959334";
	// secretId
	private static final String secretId = "AKID4UnrgpmUvPejvrtXCcrtmRqyB8oCquDF";
	// secretKey
	private static final String secretKey = "8VHvSlhMlvoCG5eAPBh3QecJx61nI3by";
	...
	public static String uploadfile(File localFile) throws CosClientException, CosServiceException {
		...
		try {	
			...
			// 指定要上传到 COS 上的路径
			fileName = "guanggao/BigShow/"+random.nextInt(10000) + System.currentTimeMillis() + substring;
